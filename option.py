...
class Options():
    def __init__(self):
        ...
        parser.add_argument('--lr-decay', type=float, default=100, metavar='LD',
            help='epochs for learning rate daecy (default: 50)')
        ...
        parser.add_argument('--eval', action='store_true', default= False,
            help='evaluating')
        parser.add_argument('--boarddir', type=str, default='defualt',
                            help='logdir')
